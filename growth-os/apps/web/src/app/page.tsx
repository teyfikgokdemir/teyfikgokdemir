...
export default function Home() {
  ...
  async function submit(e: FormEvent) {
    e.preventDefault(); setLoading(true); setError(''); setAudit(null);
    try {
  ...
  return <main className="shell">
    <aside className="side">
      ...
      <div className="stage">MVP / Audit Engine v0.1</div>
    </aside>
    ...
    <section className="content">
      ...
      {!audit && <div className="empty"><b>İlk modül aktif:</b> Teknik SEO + SEO/GEO/AEO/AIO readiness + tracking + ads readiness. Sonraki aşamada çoklu sayfa crawler, final karşılaştırma, reklam/CRM konektörleri ve aksiyon motoru eklenecek.</div>}
