    ...
    <div className="agencyShell">
      ...
      {!loading&&!error&&me?<>
        ...
        <section className="cards">
          ...
          <a href="/status"><small>OBSERVABILITY</small><h2>Sistem Durumu</h2><p>API, veritabanı readiness ve external-write guardrail durumlarını production üzerinden doğrula.</p><span>Durumu aç →</span></a>
        </section>
