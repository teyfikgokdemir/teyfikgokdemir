...
export const content = {
  ...
  vi: {
    seo: {
      title: 'Teyfik Gökdemir | Thương mại quốc tế, Thu mua chiến lược & CTSEG',
      description: 'Nhà sáng lập CTSEG Teyfik Gökdemir; xây dựng hệ thống thương mại quốc tế, thu mua chiến lược, xác minh nhà cung cấp và vận hành thương mại tại Thổ Nhĩ Kỳ, khu vực Balkan và toàn cầu.',
    },
    a11y: { skip: 'Chuyển đến nội dung chính', language: 'Chọn ngôn ngữ', menuOpen: 'Mở menu', menuClose: 'Đóng menu', external: 'mở trong tab mới' },
    nav: { ventures: 'Dự án & Doanh nghiệp', expertise: 'Chuyên môn', journey: 'Hành trình', contact: 'Liên hệ' },
    hero: {
      eyebrow: 'Trụ sở tại Thổ Nhĩ Kỳ · Trọng tâm vùng Balkan · Thị trường quốc tế',
      title: 'Chuyển hóa các dự án kinh doanh số từ ý tưởng thành hệ thống vận hành thực tế.',
      description: 'Hợp nhất thương mại điện tử, xây dựng thương hiệu, công nghệ, tiếp thị và vận hành vào một cấu trúc thương mại nhất quán nhằm tạo lập các hệ thống bán hàng và doanh nghiệp có khả năng mở rộng quy mô.',
      primary: 'Khám phá các dự án',
      secondary: 'Liên hệ hợp tác',
      summary: 'Teyfik Gökdemir là nhà sáng lập và chuyên gia điều phối thương mại số tại Thổ Nhĩ Kỳ; phát triển các doanh nghiệp và hệ thống tăng trưởng cho thị trường Thổ Nhĩ Kỳ, vùng Balkan và quốc tế.',
    },
    intro: {
      label: 'Góc nhìn nhà sáng lập',
      title: 'Thu hẹp khoảng cách giữa định hướng chiến lược và thực thi thực tế.',
      body: 'Tôi không tiếp cận một dự án kinh doanh đơn thuần như một trang web hay chiến dịch quảng cáo. Sản phẩm, bán hàng, trải nghiệm khách hàng, vận hành chuỗi cung ứng, hạ tầng công nghệ và các kênh tăng trưởng đều được thiết kế đồng bộ.',
      areas: ['Phát triển dự án kinh doanh', 'Thương mại số', 'Hệ thống tăng trưởng', 'Vận hành ứng dụng AI'],
    },
    ventures: {
      label: 'Dự án & Hệ thống vận hành',
      title: 'Phục vụ nhiều thị trường với cùng một kỷ luật vận hành chuẩn mực.',
      lead: 'Mỗi cấu trúc kinh doanh kết hợp nhu cầu thị trường cụ thể với giải pháp công nghệ khả thi và quy trình vận hành bền vững.',
      items: [
        { name: 'QCT Studio', description: 'Đơn vị tăng trưởng số phát triển hệ thống web đa ngôn ngữ, thương mại điện tử, SEO/GEO và tự động hóa AI cho các doanh nghiệp tại Albania, Bắc Macedonia và khu vực.', status: 'Đang hoạt động', region: 'Vùng Balkan', url: 'https://qctstudio.com', aria: 'Truy cập website QCT Studio' },
        { name: 'QCT Commerce', description: 'Đơn vị phát triển hạ tầng thương mại số, bán hàng trực tiếp và thương mại điện tử quy mô lớn cho các nhà sản xuất, bán buôn tại Thổ Nhĩ Kỳ.', status: 'Đang hoạt động', region: 'Thổ Nhĩ Kỳ', url: 'https://qctcommerce.com', aria: 'Truy cập website QCT Commerce', image: 'commerce' },
        { name: 'Mythborn', description: 'Thương hiệu tiêu dùng số độc lập kết hợp các trải nghiệm Tarot, Katina, chiêm tinh và khám phá cá nhân trên nền tảng kỹ thuật số đa ngôn ngữ.', status: 'Đang hoạt động', region: 'Quốc tế', url: 'https://mythborn.co/', aria: 'Truy cập website Mythborn' },
        { name: 'Sales Intelligence Systems', description: 'Hệ thống nghiên cứu thông minh ứng dụng AI phục vụ tìm kiếm khách hàng tiềm năng, nhận diện tín hiệu cơ hội, phân tích doanh nghiệp và chuẩn bị dữ liệu CRM bán hàng.', status: 'Hệ thống nội bộ', region: 'Vận hành bán hàng', aria: 'Tìm hiểu về Sales Intelligence Systems' },
        { name: 'AI Operations Framework', description: 'Hệ thống phương pháp làm việc ứng dụng AI nhằm chuẩn hóa các quy trình nghiên cứu, xây dựng nội dung, đề xuất thương mại, quản lý dự án và phối hợp nhóm.', status: 'Hệ thống nội bộ', region: 'Vận hành', aria: 'Tìm hiểu về AI Operations Framework' },
      ],
    },
    expertise: {
      label: 'Chuyên môn & Năng lực',
      title: 'Các lĩnh vực chuyên môn bao quát toàn bộ hệ thống thương mại.',
      lead: 'Chiến lược, công nghệ và thực thi thường nhật được kết nối chặt chẽ hướng tới cùng một mục tiêu kinh doanh cụ thể.',
      groups: [
        { title: 'Thương mại', items: ['Chiến lược thương mại điện tử', 'Shopify', 'WooCommerce', 'Vận hành sàn thương mại điện tử', 'Tối ưu hóa tỷ lệ chuyển đổi', 'Hành trình khách hàng', 'Bán hàng trực tiếp tới người tiêu dùng (D2C)', 'Thương mại số B2B'] },
        { title: 'Tăng trưởng', items: ['SEO', 'GEO', 'AEO', 'AIO', 'Chiến lược nội dung', 'Quảng cáo Meta Ads', 'Quảng cáo Google Ads', 'Chiến lược Landing Page', 'Hoạch định tăng trưởng số'] },
        { title: 'Vận hành', items: ['Chuỗi cung ứng', 'Logistics quốc tế', 'Quản trị dự án', 'Vận hành kỹ thuật số', 'Điều phối đội ngũ', 'Kế hoạch thương mại', 'Thiết kế quy trình'] },
        { title: 'Hệ thống AI', items: ['Quy trình nghiên cứu ứng dụng AI', 'Thông tin kinh doanh & Bán hàng', 'Tự động hóa quy trình', 'Vận hành hỗ trợ bởi AI', 'Hệ thống nội dung', 'Nghiên cứu khách hàng tiềm năng', 'Quản trị tri thức'] },
      ],
      definitions: 'SEO: Tối ưu hóa công cụ tìm kiếm · GEO: Tối ưu hóa công cụ tạo sinh (Generative Engine) · AEO: Tối ưu hóa công cụ trả lời · AIO: Tối ưu hóa trí tuệ nhân tạo',
    },
    journey: {
      label: 'Hành trình nhà sáng lập',
      title: 'Tích lũy thực tiễn từ vận hành trực tiếp đến xây dựng doanh nghiệp.',
      lead: 'Dòng thời gian phản ánh sự mở rộng có chiều sâu của trọng tâm chuyên môn và năng lực vận hành.',
      items: [
        { year: '2019', title: 'Vận hành thương mại điện tử', description: 'Phát triển kênh bán hàng, xử lý đơn hàng, trải nghiệm khách hàng và quản lý thương mại thường nhật.' },
        { year: '2023', title: 'Lãnh đạo thương mại và tăng trưởng', description: 'Kết hợp kế hoạch thương mại với các kênh tăng trưởng số hướng tới mục tiêu chung.' },
        { year: '2024', title: 'Định hướng tiếp thị số', description: 'Quản trị đồng bộ hệ thống nội dung, hiệu suất chuyển đổi và phát triển thương hiệu.' },
        { year: '2026', title: 'QCT Studio', description: 'Xây dựng hệ thống tăng trưởng số đa ngôn ngữ cho các doanh nghiệp khu vực Balkan.' },
        { year: '2026', title: 'QCT Commerce', description: 'Thiết lập hạ tầng thương mại số cho các nhà sản xuất và doanh nghiệp tại Thổ Nhĩ Kỳ.' },
        { year: '2026', title: 'CTSEG', description: 'Nền tảng thương mại trọng tâm cho thu mua chiến lược, xác minh nhà cung cấp và điều phối xuất nhập khẩu quốc tế.' },
      ],
    },
    method: {
      label: 'Phương thức hoạt động',
      title: 'Trực diện, dựa trên dữ liệu thực chứng và phù hợp với thực tế vận hành.',
      lead: 'Mỗi dự án đều tuân theo quy trình chuẩn xác: loại bỏ giả định chủ quan, làm rõ trách nhiệm của các bên và xác định các bước hành động cụ thể.',
      steps: [
        { title: 'Nghiên cứu', description: 'Hệ thống hóa thông tin sản phẩm, thị trường mục tiêu, năng lực nhà sản xuất và tín hiệu nhu cầu qua các kênh tin cậy.' },
        { title: 'Xác minh', description: 'Đối chiếu năng lực pháp lý nhà cung cấp, sản lượng thực tế, báo cáo kiểm nghiệm, chứng từ hợp chuẩn và điều khoản thương mại.' },
        { title: 'Cấu trúc hóa', description: 'Chuyển đổi phương án báo giá, rủi ro tiềm ẩn, phương thức thanh toán, logistics quốc tế thành mô hình ra quyết định rõ ràng.' },
        { title: 'Điều phối', description: 'Điều phối trực tiếp, minh bạch các mốc thực thi trọng yếu giữa các đối tác và các bộ phận vận hành.' },
      ],
    },
    regional: {
      label: 'Tầm nhìn khu vực',
      title: 'Từ Thổ Nhĩ Kỳ đến vùng Balkan, từ nhu cầu nội địa đến thị trường toàn cầu.',
      body: 'Kết hợp kinh nghiệm thương mại và vận hành tại Thổ Nhĩ Kỳ với nhu cầu đa ngôn ngữ và thương mại xuyên biên giới tại các thị trường Balkan và quốc tế. Các cấu trúc được xây dựng tôn trọng đặc thù địa phương đồng thời sẵn sàng mở rộng quy mô toàn cầu.',
    },
    contact: {
      label: 'Trao đổi thương mại chiến lược',
      title: 'Cùng thảo luận về định vị sản phẩm, tiếp cận thị trường hoặc giải pháp chuỗi cung ứng.',
      body: 'Nếu bạn đang tìm kiếm đánh giá chiến lược ở cấp độ nhà sáng lập, mở rộng thị trường Thổ Nhĩ Kỳ hoặc thiết lập quan hệ hợp tác trực tiếp, vui lòng liên hệ trực tiếp.',
      action: 'Gửi email trao đổi',
    },
    footer: { rights: '© 2026 Teyfik Gökdemir. Bảo lưu mọi quyền.', links: 'Liên kết chính thức' },
    images: {
      hero: 'Chân dung Teyfik Gökdemir với áo cổ lọ đen',
      profile: 'Chân dung chuyên nghiệp Teyfik Gökdemir',
      executive: 'Chân dung quản trị đại diện hành trình sáng lập của Teyfik Gökdemir',
      regional: 'Teyfik Gökdemir phía trước khung cảnh thành phố',
      commerce: 'Teyfik Gökdemir tại sự kiện QCT Commerce',
    },
  },
