  ...
  tr: {
    ...
    ventures: {
      ...
      items: [
        ...
        { name: 'Mythborn', description: 'Uluslararası pazara yönelik marka, ürün ve dijital ticaret ekosistemi olarak geliştirilmekte olan yeni girişim.', status: 'Geliştirme aşamasında', region: 'Uluslararası', url: 'https://mythborn.co', aria: 'Mythborn web sitesini ziyaret et' },
  ...
  en: {
    ...
    ventures: {
      ...
      items: [
        ...
        { name: 'Mythborn', description: 'A new venture in development as a brand, product and digital commerce ecosystem for international markets.', status: 'In development', region: 'International', url: 'https://mythborn.co', aria: 'Visit the Mythborn website' },
  ...
  mk: {
    ...
    ventures: {
      ...
      items: [
        ...
        { name: 'Mythborn', description: 'Нов потфат во развој како екосистем за бренд, производ и дигитална трговија на меѓународните пазари.', status: 'Во развој', region: 'Меѓународно', url: 'https://mythborn.co', aria: 'Посети ја веб-страницата на Mythborn' },
  ...
  sr: {
    ...
    ventures: {
      ...
      items: [
        ...
        { name: 'Mythborn', description: 'Novi poduhvat u razvoju kao ekosistem brenda, proizvoda i digitalne trgovine za međunarodna tržišta.', status: 'U razvoju', region: 'Međunarodno', url: 'https://mythborn.co', aria: 'Poseti veb-sajt Mythborn' },
  ...
  sq: {
    ...
    ventures: {
      ...
      items: [
        ...
        { name: 'Mythborn', description: 'Sipërmarrje e re në zhvillim si ekosistem marke, produkti dhe tregtie digjitale për tregjet ndërkombëtare.', status: 'Në zhvillim', region: 'Ndërkombëtare', url: 'https://mythborn.co', aria: 'Vizito faqen e Mythborn' },
